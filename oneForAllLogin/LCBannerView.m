...
- (void)addSubviewToScrollView:(UIScrollView *)scrollView {
    ...
    for (int i = 0; i < self.count + 2; i++) {
        ...
        if (self.imageName.length > 0) {    // from local
            ...
            [imageView setImageWithURL:[NSURL URLWithString:self.imageURLs[tag -1]] placeholder:self.placeholderImageName.length >0 ? [UIImage imageNamed:self.placeholderImageName] :nil];
